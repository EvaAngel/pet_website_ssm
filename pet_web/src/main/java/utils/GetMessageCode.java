...
public class GetMessageCode {
	...
	private static final String ACCOUNT_SID = "fd98a439c15343618c6858d387f65ff3";
	//AUTH_TOKEN是秒嘀的开发者信息中的AUTH TOKEN，需要自己去秒嘀网站获取
	private static final String AUTH_TOKEN = "e2f7f24364ac4c438b516c92ca5fc4d0";
	private static final String SENCOND="60";
	/**
	 * 发送验证码
	 * @param telephone
	 * @return
	...
	public static String getCode(String telephone){
		...
		//random 是生成的验证码。
		String tamp = "【宠物社区】您的验证码为"+random+"，请于"+SENCOND+"分钟内正确输入，如非本人操作，请忽略此短信。";
